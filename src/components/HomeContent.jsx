...
const HomeContent = () => {
  return (
    <div className="flex w-4/5   flex-col h-[90%]  lg:flex-row mx-auto md:p-[30px] lg:p-[50px] lg:mb-[50px] lg:fixed lg:bottom-0  lg:left-1/2 lg:-translate-x-1/2">
      <div className="first lg:w-1/2 w-full  h-1/2 lg:h-full flex flex-col  justify-end   text-center lg:text-left">
        <p className="tracking-widest barlow lg:text-[28px] md:text-[20px] text-[16px] text-lb">
          SO, YOU WANT TO TRAVEL TO
        </p>
        <h1 className="text-white text-[80px] md:text-[150px]">SPACE</h1>
        <p className="text-lb md:max-w-[444px] w-full  barlow mx-auto lg:mx-0 text-[15px] md:text-[16px] tracking-widest lg:text-[18px]">
      ...
      <div className="second  relative w-full lg:w-1/2  h-1/2 lg:h-full ">
